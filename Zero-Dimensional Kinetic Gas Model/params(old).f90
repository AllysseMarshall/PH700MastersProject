...
! for he_n2_o2.f90
 ...
 real(DP),parameter :: p=110e3_dp             ! pressure of neutral gas [Pa] 
 real(DP),parameter :: T_g=50_dp             ! temperature of neutral gas [K]
 real(DP),parameter :: T_e=50_dp             ! temperature of electrons [K] 
