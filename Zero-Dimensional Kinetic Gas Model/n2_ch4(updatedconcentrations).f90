...
! --- DECLARATIONS
        ...
        real(DP) :: p_CH4,p_CO2,p_CO,p_H2,Temp
...
!
        ...
        END DO  
!
!      percentage of CH4,CO2,H2 and CO in the mixture 
!
        p_CH4=0.0025_dp
!
        p_CO2=0.001_dp
...
!     
!  N2
        y(86)=(1.0_dp-p_CH4-p_CO2-p_H2-p_CO)*n_N2
!
...
!
!  CH3
        y(14)=0.89_dp*p_CH4*n_N2	!changed from 0.089 in intial code
!  CH2
...
! CO    
        y(184)=(0.05*p_CO2*n_N2)+(p_CO*n_N2)	!changed from 0.1
!
!	H2 is added as an initial value for Titan
!
!	H2
		y(3)=p_H2*n_N2
!
! Wall
	y(236)=1e-12_dp	!SSD value changed from 1e20_dp
!
...
open(1, file = 'data.dat', POSITION ='APPEND')
        write(1,92) T_g, y(3),y(17),y(21),y(95),y(96),y(103),y(105),y(184),y(188),y(196),y(206),y(220)
 92     format('',1PE12.4,',',1PE12.4,',',1PE12.4,',',1PE12.4,',',1PE12.4,',',1PE12.4,',',1PE12.4,',',1PE12.4)
